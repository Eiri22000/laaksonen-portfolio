...
return ( 
	...
	className="custom-navbar shadow-sm text-center"> 
	...
	<div className="collapse navbar-collapse text-white"
		...
		<Nav className="ml-auto"> 
		<Nav.Link href="https://github.com/eiri22000"> 
			<span className="sr-only">Github</span> 
			<FontAwesomeIcon icon={faGithub} size="lg"
			className='text-light ho' /> 
		</Nav.Link> 
		<Nav.Link href="https://linkedin.com/in/eiri-laaksonen-b595a9150"> 
